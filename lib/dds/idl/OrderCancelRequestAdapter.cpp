...
void OrderCancelRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_OrderCancelRequest::OrderCancelRequest& ddsMsg )
{
...
void OrderCancelRequestAdapter::DDS2FIX(const DistributedStockExchange_OrderCancelRequest::OrderCancelRequest& ddsMsg, FIX::Message& fixMsg)
{
