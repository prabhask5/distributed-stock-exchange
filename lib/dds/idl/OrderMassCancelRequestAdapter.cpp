...
void OrderMassCancelRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_OrderMassCancelRequest::OrderMassCancelRequest& ddsMsg )
{
...
void OrderMassCancelRequestAdapter::DDS2FIX(const DistributedStockExchange_OrderMassCancelRequest::OrderMassCancelRequest& ddsMsg, FIX::Message& fixMsg)
{
