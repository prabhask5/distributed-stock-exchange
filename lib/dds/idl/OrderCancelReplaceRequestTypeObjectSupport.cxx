...
/*!
 * @file OrderCancelReplaceRequestTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#include "OrderCancelReplaceRequestTypeObjectSupport.hpp"
...
namespace DistributedStockExchange_OrderCancelReplaceRequest {
// TypeIdentifier is returned by reference: dependent structures/unions are registered in this same method
void register_OrderCancelReplaceRequest_type_identifier(
        TypeIdentifierPair& type_ids_OrderCancelReplaceRequest)
{

    ReturnCode_t return_code_OrderCancelReplaceRequest {eprosima::fastdds::dds::RETCODE_OK};
    return_code_OrderCancelReplaceRequest =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "DistributedStockExchange_OrderCancelReplaceRequest::OrderCancelReplaceRequest", type_ids_OrderCancelReplaceRequest);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_OrderCancelReplaceRequest)
    {
        StructTypeFlag struct_flags_OrderCancelReplaceRequest = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_OrderCancelReplaceRequest = "DistributedStockExchange_OrderCancelReplaceRequest::OrderCancelReplaceRequest";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_OrderCancelReplaceRequest;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_OrderCancelReplaceRequest;
        CompleteTypeDetail detail_OrderCancelReplaceRequest = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_OrderCancelReplaceRequest, ann_custom_OrderCancelReplaceRequest, type_name_OrderCancelReplaceRequest.to_string());
        CompleteStructHeader header_OrderCancelReplaceRequest;
        header_OrderCancelReplaceRequest = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_OrderCancelReplaceRequest);
        CompleteStructMemberSeq member_seq_OrderCancelReplaceRequest;
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Source = TypeObjectUtils::build_complete_member_detail(name_Source, member_ann_builtin_Source, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_Source = TypeObjectUtils::build_complete_struct_member(common_Source, detail_Source);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Source);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Destination = TypeObjectUtils::build_complete_member_detail(name_Destination, member_ann_builtin_Destination, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Destination);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_SourceUser = TypeObjectUtils::build_complete_member_detail(name_SourceUser, member_ann_builtin_SourceUser, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_SourceUser = TypeObjectUtils::build_complete_struct_member(common_SourceUser, detail_SourceUser);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_SourceUser);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DestinationUser, member_ann_builtin_DestinationUser, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_DestinationUser);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_fix_header = TypeObjectUtils::build_complete_member_detail(name_fix_header, member_ann_builtin_fix_header, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_fix_header = TypeObjectUtils::build_complete_struct_member(common_fix_header, detail_fix_header);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_fix_header);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_OrigClOrdID = TypeObjectUtils::build_complete_member_detail(name_OrigClOrdID, member_ann_builtin_OrigClOrdID, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_OrigClOrdID);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_ClOrdID = TypeObjectUtils::build_complete_member_detail(name_ClOrdID, member_ann_builtin_ClOrdID, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_ClOrdID = TypeObjectUtils::build_complete_struct_member(common_ClOrdID, detail_ClOrdID);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_ClOrdID);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_ExecInst = TypeObjectUtils::build_complete_member_detail(name_ExecInst, member_ann_builtin_ExecInst, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_ExecInst = TypeObjectUtils::build_complete_struct_member(common_ExecInst, detail_ExecInst);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_ExecInst);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Symbol = TypeObjectUtils::build_complete_member_detail(name_Symbol, member_ann_builtin_Symbol, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_Symbol = TypeObjectUtils::build_complete_struct_member(common_Symbol, detail_Symbol);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Symbol);
        }
        {
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_SecurityExchange = TypeObjectUtils::build_complete_member_detail(name_SecurityExchange, member_ann_builtin_SecurityExchange, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_SecurityExchange);
        }
        {
            ...
            StructMemberFlag member_flags_Side = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Side = 0x0000000a;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Side = TypeObjectUtils::build_complete_member_detail(name_Side, member_ann_builtin_Side, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_Side = TypeObjectUtils::build_complete_struct_member(common_Side, detail_Side);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Side);
        }
        {
            ...
            StructMemberFlag member_flags_TransactTime = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_TransactTime = 0x0000000b;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_TransactTime = TypeObjectUtils::build_complete_member_detail(name_TransactTime, member_ann_builtin_TransactTime, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_TransactTime);
        }
        {
            ...
            StructMemberFlag member_flags_OrderQty = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrderQty = 0x0000000c;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_OrderQty = TypeObjectUtils::build_complete_member_detail(name_OrderQty, member_ann_builtin_OrderQty, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_OrderQty = TypeObjectUtils::build_complete_struct_member(common_OrderQty, detail_OrderQty);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_OrderQty);
        }
        {
            ...
            StructMemberFlag member_flags_OrdType = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrdType = 0x0000000d;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_OrdType = TypeObjectUtils::build_complete_member_detail(name_OrdType, member_ann_builtin_OrdType, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_OrdType = TypeObjectUtils::build_complete_struct_member(common_OrdType, detail_OrdType);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_OrdType);
        }
        {
            ...
            StructMemberFlag member_flags_Price = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Price = 0x0000000e;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Price = TypeObjectUtils::build_complete_member_detail(name_Price, member_ann_builtin_Price, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_Price = TypeObjectUtils::build_complete_struct_member(common_Price, detail_Price);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Price);
        }
        {
            ...
            StructMemberFlag member_flags_StopPx = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_StopPx = 0x0000000f;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_StopPx = TypeObjectUtils::build_complete_member_detail(name_StopPx, member_ann_builtin_StopPx, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_StopPx = TypeObjectUtils::build_complete_struct_member(common_StopPx, detail_StopPx);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_StopPx);
        }
        {
            ...
            StructMemberFlag member_flags_TimeInForce = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_TimeInForce = 0x00000010;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_TimeInForce = TypeObjectUtils::build_complete_member_detail(name_TimeInForce, member_ann_builtin_TimeInForce, ann_custom_OrderCancelReplaceRequest);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_TimeInForce);
        }
        {
            ...
            StructMemberFlag member_flags_Text = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Text = 0x00000011;
            ...
            ann_custom_OrderCancelReplaceRequest.reset();
            CompleteMemberDetail detail_Text = TypeObjectUtils::build_complete_member_detail(name_Text, member_ann_builtin_Text, ann_custom_OrderCancelReplaceRequest);
            CompleteStructMember member_Text = TypeObjectUtils::build_complete_struct_member(common_Text, detail_Text);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderCancelReplaceRequest, member_Text);
        }
        CompleteStructType struct_type_OrderCancelReplaceRequest = TypeObjectUtils::build_complete_struct_type(struct_flags_OrderCancelReplaceRequest, header_OrderCancelReplaceRequest, member_seq_OrderCancelReplaceRequest);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_OrderCancelReplaceRequest, type_name_OrderCancelReplaceRequest.to_string(), type_ids_OrderCancelReplaceRequest))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedStockExchange_OrderCancelReplaceRequest::OrderCancelReplaceRequest already registered in TypeObjectRegistry for a different type.");
        }
    }
}
