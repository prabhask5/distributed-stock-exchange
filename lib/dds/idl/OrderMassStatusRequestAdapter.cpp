...
void OrderMassStatusRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_OrderMassStatusRequest::OrderMassStatusRequest& ddsMsg )
{
...
void OrderMassStatusRequestAdapter::DDS2FIX(const DistributedStockExchange_OrderMassStatusRequest::OrderMassStatusRequest& ddsMsg, FIX::Message& fixMsg)
{
	HeaderAdapter::DDS2FIX(ddsMsg.fix_header(), fixMsg.getHeader());

	convert_dds_string_to_fix(ddsMsg.MassStatusReqID(), FIX::FIELD::MassStatusReqID, fixMsg);
