...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_MARKETDATASNAPSHOTFULLREFRESH_MARKETDATASNAPSHOTFULLREFRESH_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_MARKETDATASNAPSHOTFULLREFRESH_MARKETDATASNAPSHOTFULLREFRESH_HPP
...
public:
  ...
  eProsima_user_DllExport bool operator==(const NoMDEntries &x) const {
    return (m_MDEntryType == x.m_MDEntryType && m_MDEntryPx == x.m_MDEntryPx &&
            m_MDEntrySize == x.m_MDEntrySize &&
...
/*!
 * @brief This class represents the structure MarketDataSnapshotFullRefresh
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object MarketDataSnapshotFullRefresh that will be
   * copied.
   */
  eProsima_user_DllExport
  MarketDataSnapshotFullRefresh(const MarketDataSnapshotFullRefresh &x) {
    m_Source = x.m_Source;
   ...
   */
  eProsima_user_DllExport
  MarketDataSnapshotFullRefresh(MarketDataSnapshotFullRefresh &&x) noexcept {
   ...
   */
  eProsima_user_DllExport MarketDataSnapshotFullRefresh &
  operator=(const MarketDataSnapshotFullRefresh &x) {
   ...
   */
  eProsima_user_DllExport MarketDataSnapshotFullRefresh &
  operator=(MarketDataSnapshotFullRefresh &&x) noexcept {
  ...
  operator==(const MarketDataSnapshotFullRefresh &x) const {
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_MARKETDATASNAPSHOTFULLREFRESH_MARKETDATASNAPSHOTFULLREFRESH_HPP_
