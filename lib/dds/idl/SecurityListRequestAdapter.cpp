...
void SecurityListRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_SecurityListRequest::SecurityListRequest& ddsMsg )
{
...
void SecurityListRequestAdapter::DDS2FIX(const DistributedStockExchange_SecurityListRequest::SecurityListRequest& ddsMsg, FIX::Message& fixMsg)
{
