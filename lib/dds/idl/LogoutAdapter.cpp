...
void LogoutAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_Logout::Logout& ddsMsg )
{
...
void LogoutAdapter::DDS2FIX(const DistributedStockExchange_Logout::Logout& ddsMsg, FIX::Message& fixMsg)
{
