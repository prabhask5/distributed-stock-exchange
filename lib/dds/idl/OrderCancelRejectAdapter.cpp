...
void OrderCancelRejectAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_OrderCancelReject::OrderCancelReject& ddsMsg )
{
...
void OrderCancelRejectAdapter::DDS2FIX(const DistributedStockExchange_OrderCancelReject::OrderCancelReject& ddsMsg, FIX::Message& fixMsg)
{
