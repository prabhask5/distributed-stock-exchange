...
void MarketDataRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_MarketDataRequest::MarketDataRequest& ddsMsg )
{
...
void MarketDataRequestAdapter::DDS2FIX(const DistributedStockExchange_MarketDataRequest::MarketDataRequest& ddsMsg, FIX::Message& fixMsg)
{
