...
namespace DistributedStockExchange_ExecutionReport {
    ...
    {
        set_name("DistributedStockExchange_ExecutionReport::ExecutionReport");
        uint32_t type_size = DistributedStockExchange_ExecutionReport_ExecutionReport_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedStockExchange_ExecutionReport_ExecutionReport_max_key_cdr_typesize > 16 ? DistributedStockExchange_ExecutionReport_ExecutionReport_max_key_cdr_typesize : 16;
            ...
            bool force_md5)
    {
        ...
        if (force_md5 || DistributedStockExchange_ExecutionReport_ExecutionReport_max_key_cdr_typesize > 16)
        {
            md5_.init();
