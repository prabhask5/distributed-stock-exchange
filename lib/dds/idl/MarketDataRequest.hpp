...
/*!
 * @brief This class represents the structure NoMDEntryTypes defined by the user
 * in the IDL file.
...
public:
   ...
   */
  eProsima_user_DllExport NoMDEntryTypes(const NoMDEntryTypes &x) {
   ...
   * @param x Reference to the object NoMDEntryTypes that will be copied.
   */
  eProsima_user_DllExport NoMDEntryTypes(NoMDEntryTypes &&x) noexcept {
    m_MDEntryType = x.m_MDEntryType;
  }
   ...
   * @param x Reference to the object NoMDEntryTypes that will be copied.
   */
  eProsima_user_DllExport NoMDEntryTypes &operator=(const NoMDEntryTypes &x) {
   ...
   */
  eProsima_user_DllExport NoMDEntryTypes &
  operator=(NoMDEntryTypes &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const NoMDEntryTypes &x) const {
...
/*!
 * @brief This class represents the structure MarketDataRequest defined by the
...
public:
   ...
   */
  eProsima_user_DllExport MarketDataRequest(const MarketDataRequest &x) {
    m_Source = x.m_Source;
   ...
   * @param x Reference to the object MarketDataRequest that will be copied.
   */
  eProsima_user_DllExport MarketDataRequest(MarketDataRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport MarketDataRequest &
  operator=(const MarketDataRequest &x) {
   ...
   */
  eProsima_user_DllExport MarketDataRequest &
  operator=(MarketDataRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const MarketDataRequest &x) const {
   ...
   * @param _SubscriptionRequestType New value for member
   * SubscriptionRequestType
   */
  eProsima_user_DllExport void
  SubscriptionRequestType(char _SubscriptionRequestType) {
   ...
   */
  eProsima_user_DllExport void MarketDepth(int32_t _MarketDepth) {
   ...
   */
  eProsima_user_DllExport int32_t MarketDepth() const { return m_MarketDepth; }

  /*!
   * @brief This function returns a reference to member MarketDepth
   * @return Reference to member MarketDepth
   */
  eProsima_user_DllExport int32_t &MarketDepth() { return m_MarketDepth; }
   ...
   */
  eProsima_user_DllExport void
  c_NoMDEntryTypes(const NoMDEntryTypesSeq &_c_NoMDEntryTypes) {
   ...
   */
  eProsima_user_DllExport void
  c_NoMDEntryTypes(NoMDEntryTypesSeq &&_c_NoMDEntryTypes) {
