...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_SECURITYLISTREQUEST_SECURITYLISTREQUEST_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_SECURITYLISTREQUEST_SECURITYLISTREQUEST_HPP
...
/*!
 * @brief This class represents the structure SecurityListRequest defined by the
...
public:
   ...
   */
  eProsima_user_DllExport SecurityListRequest(const SecurityListRequest &x) {
    m_Source = x.m_Source;
  ...
  SecurityListRequest(SecurityListRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport SecurityListRequest &
  operator=(const SecurityListRequest &x) {
   ...
   */
  eProsima_user_DllExport SecurityListRequest &
  operator=(SecurityListRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const SecurityListRequest &x) const {
   ...
   * @param _SecurityListRequestType New value for member
   * SecurityListRequestType
   */
  eProsima_user_DllExport void
  SecurityListRequestType(int32_t _SecurityListRequestType) {
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_SECURITYLISTREQUEST_SECURITYLISTREQUEST_HPP_
