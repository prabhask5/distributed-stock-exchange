...
/*!
 * @file OrderMassCancelReport.hpp
...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_ORDERMASSCANCELREPORT_ORDERMASSCANCELREPORT_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_ORDERMASSCANCELREPORT_ORDERMASSCANCELREPORT_HPP
...
/*!
 * @brief This class represents the structure OrderMassCancelReport defined by
...
public:
   ...
   * @param x Reference to the object OrderMassCancelReport that will be copied.
   */
  eProsima_user_DllExport
  OrderMassCancelReport(const OrderMassCancelReport &x) {
    m_Source = x.m_Source;
    ...
    m_MassCancelResponse = x.m_MassCancelResponse;
   ...
   */
  eProsima_user_DllExport
  OrderMassCancelReport(OrderMassCancelReport &&x) noexcept {
   ...
   */
  eProsima_user_DllExport OrderMassCancelReport &
  operator=(const OrderMassCancelReport &x) {
   ...
   */
  eProsima_user_DllExport OrderMassCancelReport &
  operator=(OrderMassCancelReport &&x) noexcept {
   ...
   * @param x OrderMassCancelReport object to compare.
   */
  eProsima_user_DllExport bool
  operator==(const OrderMassCancelReport &x) const {
  ...
  eProsima_user_DllExport void MassCancelResponse(char _MassCancelResponse) {
    m_MassCancelResponse = _MassCancelResponse;
  }
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_ORDERMASSCANCELREPORT_ORDERMASSCANCELREPORT_HPP_
