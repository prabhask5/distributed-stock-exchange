...
void OrderCancelReplaceRequestAdapter::FIX2DDS(
    const FIX::Message &fixMsg,
    DistributedStockExchange_OrderCancelReplaceRequest::
  ...
  if (fixMsg.isSetField(FIX::FIELD::ClOrdID))
    ddsMsg.ClOrdID(((FIX::ClOrdID)fixMsg.getField(FIX::FIELD::ClOrdID))
                       .getString()
                       .c_str());
...
void OrderCancelReplaceRequestAdapter::DDS2FIX(
    const DistributedStockExchange_OrderCancelReplaceRequest::
        OrderCancelReplaceRequest &ddsMsg,
    FIX::Message &fixMsg) {
