...
void OrderCancelReplaceRequestAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_OrderCancelReplaceRequest::OrderCancelReplaceRequest& ddsMsg )
{
...
void OrderCancelReplaceRequestAdapter::DDS2FIX(const DistributedStockExchange_OrderCancelReplaceRequest::OrderCancelReplaceRequest& ddsMsg, FIX::Message& fixMsg)
{
	...
	convert_dds_string_to_fix(ddsMsg.ClOrdID(), FIX::FIELD::ClOrdID, fixMsg);
