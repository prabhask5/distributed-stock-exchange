...
void NewOrderSingleAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_NewOrderSingle::NewOrderSingle& ddsMsg )
{
...
void NewOrderSingleAdapter::DDS2FIX(const DistributedStockExchange_NewOrderSingle::NewOrderSingle& ddsMsg, FIX::Message& fixMsg)
{
