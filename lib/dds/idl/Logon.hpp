...
/*!
 * @brief This class represents the structure Logon defined by the user in the
 * IDL file.
 * @ingroup Logon
 */
class Logon {
public:
   ...
   */
  eProsima_user_DllExport Logon(const Logon &x) {
    m_Source = x.m_Source;
   ...
   * @param x Reference to the object Logon that will be copied.
   */
  eProsima_user_DllExport Logon(Logon &&x) noexcept {
   ...
   * @param x Reference to the object Logon that will be copied.
   */
  eProsima_user_DllExport Logon &operator=(const Logon &x) {
   ...
   * @param x Reference to the object Logon that will be copied.
   */
  eProsima_user_DllExport Logon &operator=(Logon &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const Logon &x) const {
    return (m_Source == x.m_Source && m_Destination == x.m_Destination &&
            m_SourceUser == x.m_SourceUser &&
            m_DestinationUser == x.m_DestinationUser &&
            m_fix_header == x.m_fix_header &&
            m_EncryptMethod == x.m_EncryptMethod &&
            m_HeartBtInt == x.m_HeartBtInt && m_RawData == x.m_RawData &&
            m_Username == x.m_Username && m_Password == x.m_Password);
  }
   ...
   */
  eProsima_user_DllExport void EncryptMethod(int32_t _EncryptMethod) {
   ...
   */
  eProsima_user_DllExport int32_t &EncryptMethod() { return m_EncryptMethod; }

  /*!
   * @brief This function sets a value in member HeartBtInt
   * @param _HeartBtInt New value for member HeartBtInt
   */
  eProsima_user_DllExport void HeartBtInt(int32_t _HeartBtInt) {
   ...
   */
  eProsima_user_DllExport void RawData(std::string &&_RawData) {
   ...
   */
  eProsima_user_DllExport std::string &RawData() { return m_RawData; }

  /*!
   * @brief This function copies the value in member Username
   * @param _Username New value to be copied in member Username
   */
  eProsima_user_DllExport void Username(const std::string &_Username) {
   ...
   */
  eProsima_user_DllExport void Username(std::string &&_Username) {
   ...
   */
  eProsima_user_DllExport std::string &Username() { return m_Username; }

  /*!
   * @brief This function copies the value in member Password
   * @param _Password New value to be copied in member Password
   */
  eProsima_user_DllExport void Password(const std::string &_Password) {
   ...
   */
  eProsima_user_DllExport void Password(std::string &&_Password) {
   ...
   */
  eProsima_user_DllExport std::string &Password() { return m_Password; }
