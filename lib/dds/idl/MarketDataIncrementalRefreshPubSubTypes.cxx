...
namespace DistributedStockExchange_MarketDataIncrementalRefresh {
    ...
    {
        set_name("DistributedStockExchange_MarketDataIncrementalRefresh::NoMDEntries");
        uint32_t type_size = DistributedStockExchange_MarketDataIncrementalRefresh_NoMDEntries_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedStockExchange_MarketDataIncrementalRefresh_NoMDEntries_max_key_cdr_typesize > 16 ? DistributedStockExchange_MarketDataIncrementalRefresh_NoMDEntries_max_key_cdr_typesize : 16;
            ...
            bool force_md5)
    {
        ...
        if (force_md5 || DistributedStockExchange_MarketDataIncrementalRefresh_NoMDEntries_max_key_cdr_typesize > 16)
        {
            md5_.init();
    ...
    {
        set_name("DistributedStockExchange_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh");
        uint32_t type_size = DistributedStockExchange_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedStockExchange_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_key_cdr_typesize > 16 ? DistributedStockExchange_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_key_cdr_typesize : 16;
        key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
        memset(key_buffer_, 0, key_length);
    }
            ...
            bool force_md5)
    {
        ...
        ser.set_encoding_flag(eprosima::fastcdr::EncodingAlgorithmFlag::PLAIN_CDR2);
        eprosima::fastcdr::serialize_key(ser, *p_type);
        if (force_md5 || DistributedStockExchange_MarketDataIncrementalRefresh_MarketDataIncrementalRefresh_max_key_cdr_typesize > 16)
        {
            md5_.init();
            md5_.update(key_buffer_, static_cast<unsigned int>(ser.get_serialized_data_length()));
            md5_.finalize();
