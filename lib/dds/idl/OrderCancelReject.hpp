...
/*!
 * @brief This class represents the structure OrderCancelReject defined by the
...
public:
   ...
   */
  eProsima_user_DllExport OrderCancelReject(const OrderCancelReject &x) {
    m_Source = x.m_Source;
   ...
   * @param x Reference to the object OrderCancelReject that will be copied.
   */
  eProsima_user_DllExport OrderCancelReject(OrderCancelReject &&x) noexcept {
   ...
   */
  eProsima_user_DllExport OrderCancelReject &
  operator=(const OrderCancelReject &x) {
   ...
   */
  eProsima_user_DllExport OrderCancelReject &
  operator=(OrderCancelReject &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const OrderCancelReject &x) const {
    return (m_Source == x.m_Source && m_Destination == x.m_Destination &&
            m_SourceUser == x.m_SourceUser &&
            m_DestinationUser == x.m_DestinationUser &&
            m_fix_header == x.m_fix_header && m_OrderID == x.m_OrderID &&
            m_ClOrdID == x.m_ClOrdID && m_OrigClOrdID == x.m_OrigClOrdID &&
            m_OrdStatus == x.m_OrdStatus &&
            m_TransactTime == x.m_TransactTime &&
            m_CxlRejResponseTo == x.m_CxlRejResponseTo && m_Text == x.m_Text);
  }
   ...
   */
  eProsima_user_DllExport void CxlRejResponseTo(char _CxlRejResponseTo) {
