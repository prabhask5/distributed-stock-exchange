...
void MarketDataIncrementalRefreshAdapter::FIX2DDS(const FIX::Message& fixMsg, DistributedStockExchange_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh& ddsMsg )
{
...
void MarketDataIncrementalRefreshAdapter::DDS2FIX(const DistributedStockExchange_MarketDataIncrementalRefresh::MarketDataIncrementalRefresh& ddsMsg, FIX::Message& fixMsg)
{
...
;
	...
	convert_dds_string_to_fix(ddsMsg.c_NoMDEntries()[NoMDEntries_group_cnt_index].Symbol(), FIX::FIELD::Symbol, grp);

	convert_dds_string_to_fix(ddsMsg.c_NoMDEntries()[NoMDEntries_group_cnt_index].SecurityExchange(), FIX::FIELD::SecurityExchange, grp);
	...
	convert_dds_string_to_fix(ddsMsg.c_NoMDEntries()[NoMDEntries_group_cnt_index].ExecInst(), FIX::FIELD::ExecInst, grp);

	convert_dds_string_to_fix(ddsMsg.c_NoMDEntries()[NoMDEntries_group_cnt_index].Text(), FIX::FIELD::Text, grp);
