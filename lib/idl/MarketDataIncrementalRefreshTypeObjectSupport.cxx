        ...
        TypeIdentifierPair& type_ids_NoMDEntries)
{
    ...
    return_code_NoMDEntries =
        ...
        "MarketDataIncrementalRefresh::NoMDEntries", type_ids_NoMDEntries);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntries)
    {
        StructTypeFlag struct_flags_NoMDEntries = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_NoMDEntries = "MarketDataIncrementalRefresh::NoMDEntries";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "MarketDataIncrementalRefresh::NoMDEntries already registered in TypeObjectRegistry for a different type.");
        }
    }
}
        ...
        TypeIdentifierPair& type_ids_NoMDEntriesSeq)
{
    ...
    return_code_NoMDEntriesSeq =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "MarketDataIncrementalRefresh::NoMDEntriesSeq", type_ids_NoMDEntriesSeq);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
    {
        AliasTypeFlag alias_flags_NoMDEntriesSeq = 0;
        QualifiedTypeName type_name_NoMDEntriesSeq = "MarketDataIncrementalRefresh::NoMDEntriesSeq";
        ...
        return_code_NoMDEntriesSeq =
            eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
            "anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded", type_ids_NoMDEntriesSeq);

        if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
        {
            return_code_NoMDEntriesSeq =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "MarketDataIncrementalRefresh::NoMDEntries", type_ids_NoMDEntriesSeq);

            if (eprosima::fastdds::dds::RETCODE_OK != return_code_NoMDEntriesSeq)
            {
                MarketDataIncrementalRefresh::register_NoMDEntries_type_identifier(type_ids_NoMDEntriesSeq);
            }
            bool element_identifier_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded_ec {false};
            TypeIdentifier* element_identifier_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded {new TypeIdentifier(TypeObjectUtils::retrieve_complete_type_identifier(type_ids_NoMDEntriesSeq, element_identifier_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded_ec))};
            if (!element_identifier_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded_ec)
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "Sequence element TypeIdentifier inconsistent.");
                return;
            }
            EquivalenceKind equiv_kind_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded = EK_COMPLETE;
            if (TK_NONE == type_ids_NoMDEntriesSeq.type_identifier2()._d())
            {
                equiv_kind_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded = EK_BOTH;
            }
            CollectionElementFlag element_flags_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded = 0;
            PlainCollectionHeader header_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded = TypeObjectUtils::build_plain_collection_header(equiv_kind_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded, element_flags_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded);
            {
                SBound bound = 0;
                PlainSequenceSElemDefn seq_sdefn = TypeObjectUtils::build_plain_sequence_s_elem_defn(header_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded, bound,
                            eprosima::fastcdr::external<TypeIdentifier>(element_identifier_anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded));
                if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                        TypeObjectUtils::build_and_register_s_sequence_type_identifier(seq_sdefn, "anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded", type_ids_NoMDEntriesSeq))
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                        "anonymous_sequence_MarketDataIncrementalRefresh_NoMDEntries_unbounded already registered in TypeObjectRegistry for a different type.");
                }
            }
        }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "MarketDataIncrementalRefresh::NoMDEntriesSeq related TypeIdentifier inconsistent.");
            return;
        }
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                "MarketDataIncrementalRefresh::NoMDEntriesSeq already registered in TypeObjectRegistry for a different type.");
        }
    }
}
        ...
        TypeIdentifierPair& type_ids_MarketDataIncrementalRefresh)
{
    ...
    return_code_MarketDataIncrementalRefresh =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "MarketDataIncrementalRefresh::MarketDataIncrementalRefresh", type_ids_MarketDataIncrementalRefresh);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_MarketDataIncrementalRefresh)
    {
        StructTypeFlag struct_flags_MarketDataIncrementalRefresh = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_MarketDataIncrementalRefresh = "MarketDataIncrementalRefresh::MarketDataIncrementalRefresh";
        ...
        CompleteStructMemberSeq member_seq_MarketDataIncrementalRefresh;
        {
            ...
            CompleteMemberDetail detail_header = TypeObjectUtils::build_complete_member_detail(name_header, member_ann_builtin_header, ann_custom_MarketDataIncrementalRefresh);
            CompleteStructMember member_header = TypeObjectUtils::build_complete_struct_member(common_header, detail_header);
            TypeObjectUtils::add_complete_struct_member(member_seq_MarketDataIncrementalRefresh, member_header);
        }
        {
        ...
        }
        {
            ...
            return_code_c_NoMDEntries =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "MarketDataIncrementalRefresh::NoMDEntriesSeq", type_ids_c_NoMDEntries);

            if (eprosima::fastdds::dds::RETCODE_OK != return_code_c_NoMDEntries)
            {
                MarketDataIncrementalRefresh::register_NoMDEntriesSeq_type_identifier(type_ids_c_NoMDEntries);
            }
            StructMemberFlag member_flags_c_NoMDEntries = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_c_NoMDEntries = 0x00000002;
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "MarketDataIncrementalRefresh::MarketDataIncrementalRefresh already registered in TypeObjectRegistry for a different type.");
        }
    }
}
