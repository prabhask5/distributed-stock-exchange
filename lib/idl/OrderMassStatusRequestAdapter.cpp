...
void OrderMassStatusRequestAdapter::FIX2DDS(const FIX::Message &fixMsg, OrderMassStatusRequest::OrderMassStatusRequest &ddsMsg)
{
...
void OrderMassStatusRequestAdapter::DDS2FIX(const OrderMassStatusRequest::OrderMassStatusRequest &ddsMsg, FIX::Message &fixMsg)
{
