...
void MarketDataSnapshotFullRefreshAdapter::FIX2DDS(const FIX::Message &fixMsg, MarketDataSnapshotFullRefresh::MarketDataSnapshotFullRefresh &ddsMsg)
{
...
void MarketDataSnapshotFullRefreshAdapter::DDS2FIX(const MarketDataSnapshotFullRefresh::MarketDataSnapshotFullRefresh &ddsMsg, FIX::Message &fixMsg)
{
