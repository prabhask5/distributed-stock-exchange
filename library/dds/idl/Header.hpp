...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_HEADER_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_HEADER_HPP
...
namespace DistributedStockExchange {
...
public:
  ...
  eProsima_user_DllExport bool operator==(const Header &x) const {
    return (
        m_BeginString == x.m_BeginString && m_BodyLength == x.m_BodyLength &&
        m_MsgType == x.m_MsgType && m_SenderCompID == x.m_SenderCompID &&
        m_TargetCompID == x.m_TargetCompID && m_MsgSeqNum == x.m_MsgSeqNum &&
        m_SenderSubID == x.m_SenderSubID && m_TargetSubID == x.m_TargetSubID &&
        m_SendingTime == x.m_SendingTime);
  }
   ...
   */
  eProsima_user_DllExport void BeginString(const std::string &_BeginString) {
   ...
   */
  eProsima_user_DllExport void BeginString(std::string &&_BeginString) {
   ...
   */
  eProsima_user_DllExport void BodyLength(int32_t _BodyLength) {
   ...
   */
  eProsima_user_DllExport void MsgType(std::string &&_MsgType) {
   ...
   */
  eProsima_user_DllExport std::string &MsgType() { return m_MsgType; }
   ...
   */
  eProsima_user_DllExport void SenderCompID(const std::string &_SenderCompID) {
   ...
   */
  eProsima_user_DllExport void SenderCompID(std::string &&_SenderCompID) {
   ...
   */
  eProsima_user_DllExport std::string &SenderCompID() { return m_SenderCompID; }
   ...
   */
  eProsima_user_DllExport void TargetCompID(const std::string &_TargetCompID) {
   ...
   */
  eProsima_user_DllExport void TargetCompID(std::string &&_TargetCompID) {
   ...
   */
  eProsima_user_DllExport std::string &TargetCompID() { return m_TargetCompID; }

  /*!
   * @brief This function sets a value in member MsgSeqNum
   * @param _MsgSeqNum New value for member MsgSeqNum
   */
  eProsima_user_DllExport void MsgSeqNum(int32_t _MsgSeqNum) {
   ...
   */
  eProsima_user_DllExport int32_t MsgSeqNum() const { return m_MsgSeqNum; }

  /*!
   * @brief This function returns a reference to member MsgSeqNum
   * @return Reference to member MsgSeqNum
   */
  eProsima_user_DllExport int32_t &MsgSeqNum() { return m_MsgSeqNum; }
   ...
   */
  eProsima_user_DllExport void SenderSubID(const std::string &_SenderSubID) {
   ...
   */
  eProsima_user_DllExport void SenderSubID(std::string &&_SenderSubID) {
   ...
   */
  eProsima_user_DllExport std::string &SenderSubID() { return m_SenderSubID; }
   ...
   */
  eProsima_user_DllExport void TargetSubID(const std::string &_TargetSubID) {
   ...
   */
  eProsima_user_DllExport void TargetSubID(std::string &&_TargetSubID) {
   ...
   */
  eProsima_user_DllExport std::string &TargetSubID() { return m_TargetSubID; }

  /*!
   * @brief This function sets a value in member SendingTime
   * @param _SendingTime New value for member SendingTime
   */
  eProsima_user_DllExport void SendingTime(uint64_t _SendingTime) {
   ...
   */
  eProsima_user_DllExport uint64_t SendingTime() const { return m_SendingTime; }

  /*!
   * @brief This function returns a reference to member SendingTime
   * @return Reference to member SendingTime
   */
  eProsima_user_DllExport uint64_t &SendingTime() { return m_SendingTime; }
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_HEADER_HPP_
