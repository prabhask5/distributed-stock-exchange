...
/*!
 * @brief This class represents the structure OrderCancelRequest defined by the
...
public:
   ...
   */
  eProsima_user_DllExport OrderCancelRequest(const OrderCancelRequest &x) {
    m_Source = x.m_Source;
   ...
   * @param x Reference to the object OrderCancelRequest that will be copied.
   */
  eProsima_user_DllExport OrderCancelRequest(OrderCancelRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport OrderCancelRequest &
  operator=(const OrderCancelRequest &x) {
   ...
   */
  eProsima_user_DllExport OrderCancelRequest &
  operator=(OrderCancelRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const OrderCancelRequest &x) const {
