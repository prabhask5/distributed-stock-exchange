...
/*!
 * @file ExecutionReportTypeObjectSupport.cpp
        ...
        TypeIdentifierPair& type_ids_ExecutionReport)
{
    ...
    return_code_ExecutionReport =
        ...
        "DistributedStockExchange_ExecutionReport::ExecutionReport", type_ids_ExecutionReport);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_ExecutionReport)
    {
        StructTypeFlag struct_flags_ExecutionReport = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_ExecutionReport = "DistributedStockExchange_ExecutionReport::ExecutionReport";
        ...
        CompleteStructMemberSeq member_seq_ExecutionReport;
        {
            ...
            CompleteMemberDetail detail_Source = TypeObjectUtils::build_complete_member_detail(name_Source, member_ann_builtin_Source, ann_custom_ExecutionReport);
            CompleteStructMember member_Source = TypeObjectUtils::build_complete_struct_member(common_Source, detail_Source);
            TypeObjectUtils::add_complete_struct_member(member_seq_ExecutionReport, member_Source);
        }
        {
            ...
            ann_custom_ExecutionReport.reset();
            CompleteMemberDetail detail_Destination = TypeObjectUtils::build_complete_member_detail(name_Destination, member_ann_builtin_Destination, ann_custom_ExecutionReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_ExecutionReport, member_Destination);
        }
        {
            ...
            ann_custom_ExecutionReport.reset();
            CompleteMemberDetail detail_SourceUser = TypeObjectUtils::build_complete_member_detail(name_SourceUser, member_ann_builtin_SourceUser, ann_custom_ExecutionReport);
            CompleteStructMember member_SourceUser = TypeObjectUtils::build_complete_struct_member(common_SourceUser, detail_SourceUser);
            TypeObjectUtils::add_complete_struct_member(member_seq_ExecutionReport, member_SourceUser);
        }
        {
            ...
            ann_custom_ExecutionReport.reset();
            CompleteMemberDetail detail_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DestinationUser, member_ann_builtin_DestinationUser, ann_custom_ExecutionReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_ExecutionReport, member_DestinationUser);
        }
        {
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedStockExchange_ExecutionReport::ExecutionReport already registered in TypeObjectRegistry for a different type.");
        }
    }
}
