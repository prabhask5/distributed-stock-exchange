...
void OrderMassCancelRequestAdapter::FIX2DDS(
...
void OrderMassCancelRequestAdapter::DDS2FIX(
    const DistributedStockExchange_OrderMassCancelRequest::
        OrderMassCancelRequest &ddsMsg,
    FIX::Message &fixMsg) {
