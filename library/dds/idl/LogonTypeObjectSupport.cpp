...
/*!
 * @file LogonTypeObjectSupport.cpp
        ...
        TypeIdentifierPair& type_ids_Logon)
{
    ...
    return_code_Logon =
        ...
        "DistributedStockExchange_Logon::Logon", type_ids_Logon);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Logon)
    {
        StructTypeFlag struct_flags_Logon = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_Logon = "DistributedStockExchange_Logon::Logon";
        ...
        CompleteStructMemberSeq member_seq_Logon;
        {
            ...
            CompleteMemberDetail detail_Source = TypeObjectUtils::build_complete_member_detail(name_Source, member_ann_builtin_Source, ann_custom_Logon);
            CompleteStructMember member_Source = TypeObjectUtils::build_complete_struct_member(common_Source, detail_Source);
            TypeObjectUtils::add_complete_struct_member(member_seq_Logon, member_Source);
        }
        {
            ...
            ann_custom_Logon.reset();
            CompleteMemberDetail detail_Destination = TypeObjectUtils::build_complete_member_detail(name_Destination, member_ann_builtin_Destination, ann_custom_Logon);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logon, member_Destination);
        }
        {
            ...
            ann_custom_Logon.reset();
            CompleteMemberDetail detail_SourceUser = TypeObjectUtils::build_complete_member_detail(name_SourceUser, member_ann_builtin_SourceUser, ann_custom_Logon);
            CompleteStructMember member_SourceUser = TypeObjectUtils::build_complete_struct_member(common_SourceUser, detail_SourceUser);
            TypeObjectUtils::add_complete_struct_member(member_seq_Logon, member_SourceUser);
        }
        {
            ...
            ann_custom_Logon.reset();
            CompleteMemberDetail detail_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DestinationUser, member_ann_builtin_DestinationUser, ann_custom_Logon);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_Logon, member_DestinationUser);
        }
        {
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedStockExchange_Logon::Logon already registered in TypeObjectRegistry for a different type.");
        }
    }
}
