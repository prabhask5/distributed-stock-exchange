...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_MARKETDATAINCREMENTALREFRESH_MARKETDATAINCREMENTALREFRESH_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_MARKETDATAINCREMENTALREFRESH_MARKETDATAINCREMENTALREFRESH_HPP
...
/*!
 * @brief This class represents the structure NoMDEntries defined by the user in
 * the IDL file.
...
public:
   ...
   */
  eProsima_user_DllExport NoMDEntries(const NoMDEntries &x) {
   ...
   * @param x Reference to the object NoMDEntries that will be copied.
   */
  eProsima_user_DllExport NoMDEntries(NoMDEntries &&x) noexcept {
    m_MDUpdateAction = x.m_MDUpdateAction;
    m_MDEntryType = x.m_MDEntryType;
   ...
   * @param x Reference to the object NoMDEntries that will be copied.
   */
  eProsima_user_DllExport NoMDEntries &operator=(const NoMDEntries &x) {
   ...
   * @param x Reference to the object NoMDEntries that will be copied.
   */
  eProsima_user_DllExport NoMDEntries &operator=(NoMDEntries &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const NoMDEntries &x) const {
    return (m_MDUpdateAction == x.m_MDUpdateAction &&
            m_MDEntryType == x.m_MDEntryType && m_Symbol == x.m_Symbol &&
            m_SecurityExchange == x.m_SecurityExchange &&
            m_MDEntryPx == x.m_MDEntryPx && m_MDEntrySize == x.m_MDEntrySize &&
   ...
   */
  eProsima_user_DllExport void MDUpdateAction(char _MDUpdateAction) {
   ...
   */
  eProsima_user_DllExport char &MDUpdateAction() { return m_MDUpdateAction; }

  /*!
   * @brief This function sets a value in member MDEntryType
   * @param _MDEntryType New value for member MDEntryType
   */
  eProsima_user_DllExport void MDEntryType(char _MDEntryType) {
   ...
   */
  eProsima_user_DllExport char MDEntryType() const { return m_MDEntryType; }

  /*!
   * @brief This function returns a reference to member MDEntryType
   * @return Reference to member MDEntryType
   */
  eProsima_user_DllExport char &MDEntryType() { return m_MDEntryType; }
   ...
   */
  eProsima_user_DllExport void MDEntryPx(float _MDEntryPx) {
   ...
   */
  eProsima_user_DllExport int32_t MDEntrySize() const { return m_MDEntrySize; }

  /*!
   * @brief This function returns a reference to member MDEntrySize
   * @return Reference to member MDEntrySize
   */
  eProsima_user_DllExport int32_t &MDEntrySize() { return m_MDEntrySize; }
...
/*!
 * @brief This class represents the structure MarketDataIncrementalRefresh
...
public:
  ...
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object MarketDataIncrementalRefresh that will be
   * copied.
   */
  eProsima_user_DllExport
  MarketDataIncrementalRefresh(const MarketDataIncrementalRefresh &x) {
    m_Source = x.m_Source;
   ...
   */
  eProsima_user_DllExport
  MarketDataIncrementalRefresh(MarketDataIncrementalRefresh &&x) noexcept {
   ...
   */
  eProsima_user_DllExport MarketDataIncrementalRefresh &
  operator=(const MarketDataIncrementalRefresh &x) {
   ...
   */
  eProsima_user_DllExport MarketDataIncrementalRefresh &
  operator=(MarketDataIncrementalRefresh &&x) noexcept {
  ...
  operator==(const MarketDataIncrementalRefresh &x) const {
    return (m_Source == x.m_Source && m_Destination == x.m_Destination &&
            m_SourceUser == x.m_SourceUser &&
            m_DestinationUser == x.m_DestinationUser &&
            m_fix_header == x.m_fix_header && m_MDReqID == x.m_MDReqID &&
            m_c_NoMDEntries == x.m_c_NoMDEntries);
  }
   ...
   */
  eProsima_user_DllExport void MDReqID(const std::string &_MDReqID) {
    m_MDReqID = _MDReqID;
  }
   ...
   */
  eProsima_user_DllExport void MDReqID(std::string &&_MDReqID) {
   ...
   */
  eProsima_user_DllExport std::string &MDReqID() { return m_MDReqID; }
   ...
   */
  eProsima_user_DllExport void
  c_NoMDEntries(const NoMDEntriesSeq &_c_NoMDEntries) {
   ...
   */
  eProsima_user_DllExport void c_NoMDEntries(NoMDEntriesSeq &&_c_NoMDEntries) {
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_MARKETDATAINCREMENTALREFRESH_MARKETDATAINCREMENTALREFRESH_HPP_
