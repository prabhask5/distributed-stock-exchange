...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_ORDERCANCELREPLACEREQUEST_ORDERCANCELREPLACEREQUEST_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_ORDERCANCELREPLACEREQUEST_ORDERCANCELREPLACEREQUEST_HPP
...
/*!
 * @brief This class represents the structure OrderCancelReplaceRequest defined
...
public:
   ...
   * @param x Reference to the object OrderCancelReplaceRequest that will be
   * copied.
   */
  eProsima_user_DllExport
  OrderCancelReplaceRequest(const OrderCancelReplaceRequest &x) {
    m_Source = x.m_Source;
   ...
   */
  eProsima_user_DllExport
  OrderCancelReplaceRequest(OrderCancelReplaceRequest &&x) noexcept {
   ...
   */
  eProsima_user_DllExport OrderCancelReplaceRequest &
  operator=(const OrderCancelReplaceRequest &x) {
   ...
   */
  eProsima_user_DllExport OrderCancelReplaceRequest &
  operator=(OrderCancelReplaceRequest &&x) noexcept {
  ...
  operator==(const OrderCancelReplaceRequest &x) const {
    return (m_Source == x.m_Source && m_Destination == x.m_Destination &&
            m_SourceUser == x.m_SourceUser &&
            m_DestinationUser == x.m_DestinationUser &&
            m_fix_header == x.m_fix_header &&
            m_OrigClOrdID == x.m_OrigClOrdID && m_ClOrdID == x.m_ClOrdID &&
            m_ExecInst == x.m_ExecInst && m_Symbol == x.m_Symbol &&
            m_SecurityExchange == x.m_SecurityExchange && m_Side == x.m_Side &&
            m_TransactTime == x.m_TransactTime && m_OrderQty == x.m_OrderQty &&
            m_OrdType == x.m_OrdType && m_Price == x.m_Price &&
            m_StopPx == x.m_StopPx && m_TimeInForce == x.m_TimeInForce &&
            m_Text == x.m_Text);
  }
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_ORDERCANCELREPLACEREQUEST_ORDERCANCELREPLACEREQUEST_HPP_
