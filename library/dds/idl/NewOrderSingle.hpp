...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_NEWORDERSINGLE_NEWORDERSINGLE_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDSTOCKEXCHANGE_NEWORDERSINGLE_NEWORDERSINGLE_HPP
...
/*!
 * @brief This class represents the structure NewOrderSingle defined by the user
 * in the IDL file.
...
public:
   ...
   */
  eProsima_user_DllExport NewOrderSingle(const NewOrderSingle &x) {
    m_Source = x.m_Source;
   ...
   * @param x Reference to the object NewOrderSingle that will be copied.
   */
  eProsima_user_DllExport NewOrderSingle(NewOrderSingle &&x) noexcept {
   ...
   * @param x Reference to the object NewOrderSingle that will be copied.
   */
  eProsima_user_DllExport NewOrderSingle &operator=(const NewOrderSingle &x) {
   ...
   */
  eProsima_user_DllExport NewOrderSingle &
  operator=(NewOrderSingle &&x) noexcept {
   ...
   */
  eProsima_user_DllExport bool operator==(const NewOrderSingle &x) const {
...
#endif // _FAST_DDS_GENERATED_DISTRIBUTEDSTOCKEXCHANGE_NEWORDERSINGLE_NEWORDERSINGLE_HPP_
