...
/*!
 * @file HeaderTypeObjectSupport.cpp
        ...
        TypeIdentifierPair& type_ids_Header)
{
    ...
    return_code_Header =
        ...
        "DistributedStockExchange::Header", type_ids_Header);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Header)
    {
        StructTypeFlag struct_flags_Header = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_Header = "DistributedStockExchange::Header";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedStockExchange::Header already registered in TypeObjectRegistry for a different type.");
        }
    }
}
