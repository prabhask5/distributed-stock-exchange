...
/*!
 * @file NewOrderSingleTypeObjectSupport.cpp
        ...
        TypeIdentifierPair& type_ids_NewOrderSingle)
{
    ...
    return_code_NewOrderSingle =
        ...
        "DistributedStockExchange_NewOrderSingle::NewOrderSingle", type_ids_NewOrderSingle);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_NewOrderSingle)
    {
        StructTypeFlag struct_flags_NewOrderSingle = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_NewOrderSingle = "DistributedStockExchange_NewOrderSingle::NewOrderSingle";
        ...
        CompleteStructMemberSeq member_seq_NewOrderSingle;
        {
            ...
            CompleteMemberDetail detail_Source = TypeObjectUtils::build_complete_member_detail(name_Source, member_ann_builtin_Source, ann_custom_NewOrderSingle);
            CompleteStructMember member_Source = TypeObjectUtils::build_complete_struct_member(common_Source, detail_Source);
            TypeObjectUtils::add_complete_struct_member(member_seq_NewOrderSingle, member_Source);
        }
        {
            ...
            ann_custom_NewOrderSingle.reset();
            CompleteMemberDetail detail_Destination = TypeObjectUtils::build_complete_member_detail(name_Destination, member_ann_builtin_Destination, ann_custom_NewOrderSingle);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_NewOrderSingle, member_Destination);
        }
        {
            ...
            ann_custom_NewOrderSingle.reset();
            CompleteMemberDetail detail_SourceUser = TypeObjectUtils::build_complete_member_detail(name_SourceUser, member_ann_builtin_SourceUser, ann_custom_NewOrderSingle);
            CompleteStructMember member_SourceUser = TypeObjectUtils::build_complete_struct_member(common_SourceUser, detail_SourceUser);
            TypeObjectUtils::add_complete_struct_member(member_seq_NewOrderSingle, member_SourceUser);
        }
        {
            ...
            ann_custom_NewOrderSingle.reset();
            CompleteMemberDetail detail_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DestinationUser, member_ann_builtin_DestinationUser, ann_custom_NewOrderSingle);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_NewOrderSingle, member_DestinationUser);
        }
        {
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "DistributedStockExchange_NewOrderSingle::NewOrderSingle already registered in TypeObjectRegistry for a different type.");
        }
    }
}
